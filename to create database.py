 #program to create mysql database movie_tickets
...
mycursor.execute('USE movie_tickets')
#M1
sql3A='''INSERT INTO name values(1001,'Alladin','9am-12noon','20-march-2021',250,'Fantacy\\Family')'''
mycursor.execute(sql3A)

#M2
sql4A='''INSERT INTO name values(1002,'Insepion','12non-3pm','20-march-2021',150,'Sci-Fi')'''
mycursor.execute(sql4A)

#M3
sql5A='''INSERT INTO name values(1003,'Kgf2','3pm-6pm','20-march-2021',200,'Action\\Drama')'''
mycursor.execute(sql5A)

#M4
sql6A='''INSERT INTO name values(1004,'War','6pm-9pm','20-march-2021',150,'Action')'''
mycursor.execute(sql6A)

#M5
sql7A='''INSERT INTO name values(1005,'A Walk To Remember','9pm-12pm','20-march-2021',350,'Romantic')'''
